...
int	fdf_key(int key, t_map *map)
{
	if (key == 53 || key == 7 || key == 16 || key == 6) 
	{
		if (key == 53)
		{
			...
			map->angle_x = map->reverse ? map->angle_x - 5 * 0.0174 : map->angle_x + 5 * 0.0174; 
		else if (key == 16)
			map->angle_y = map->reverse ? map->angle_y - 5 * 0.0174 : map->angle_y + 5 * 0.0174;
		else if (key == 6)
			map->angle_z = map->reverse ? map->angle_z - 5 * 0.0174 : map->angle_z + 5 * 0.0174;
